...
function vbRenderMessage($message,$params){ ?>
    <div class="vbMessage">
    <div id="vbMessageTop_<?php echo $message->id; ?>" class="row-fluid vbMessage <?php if(!isset($message->load_more) && empty($message->activated)){ echo "vbMessageUnActivated"; } elseif(!isset($message->load_more) && empty($message->published) ) { echo "vbMessageUnpublished"; } ?>"><?php
