...
<button class="vbPostButton pull-right btn" onclick="<?php if(JRequest::getVar('start') > 0){ echo "document.location.href = '".JRoute::_('index.php?option=com_vitabook&new=true')."';"; } else { echo "vitabook.fresh();"; } ?>"><?php echo JText::_('COM_VITABOOK_NEW_MESSAGE'); ?></button>
<div class="clr"></div><br /><?php
} ?>
            ...
            <form method="post" name="vitabookMessageForm" id="vitabookMessageForm" class="form-validate <?php if($this->params->get('vbEditorOutline', 1) == 1) { ?>form-horizontal<?php } ?>"><?php //-- this id is necessary for the front/back-end detection of the vitabookupload plugin for tinymce ?><?php
                ...
                if($this->params->get('vbEditorOutline', 1) == 1) { ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <?php if($this->params->get('editor_maxchars', 0) != 0) { ?><span id="vbMaxcharsIndicatorContainer">(<?php echo JText::_('COM_VITABOOK_FORM_MAX_CHARS'); ?><span id="vbMaxcharsIndicator"> <?php echo $this->params->get('editor_maxchars', 0); ?></span>)</span><?php } ?>
                ...
                // two rows
                    ...
                    echo $this->form->getLabel('message'); if($this->params->get('editor_maxchars', 0) != 0) { ?><span id="vbMaxcharsIndicatorContainer">(<?php echo JText::_('COM_VITABOOK_FORM_MAX_CHARS'); ?><span id="vbMaxcharsIndicator"> <?php echo $this->params->get('editor_maxchars', 0); ?></span>)</span><?php }
