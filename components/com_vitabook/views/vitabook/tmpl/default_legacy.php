...
<div class="vbContainer">
    ...
    { ?>
        <div id="vbReplyButton">
            <button class="button" onclick="<?php if(JRequest::getVar('start') > 0){ echo "document.location.href = '".JRoute::_('index.php?option=com_vitabook&new=true')."';"; } else { echo "vitabook.fresh();"; } ?>"><?php echo JText::_('COM_VITABOOK_NEW_MESSAGE'); ?></button>
        </div>
        <?php
    }
