...
//TODO: This ugly hack has to go, someday ;-)
        ...
        if(JComponentHelper::getParams('com_vitabook')->get('vbForm_site') && $data['site'] == '')
        {
        ...
        if(JComponentHelper::getParams('com_vitabook')->get('vbForm_site') && $data['site'] == 'http://clear.clr')
        {
            $data['site'] = "";
        }
