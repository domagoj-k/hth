...
{  
    ...
    */      
    ...
    {     
        ...
        $body .= "----------------------------------------------\n".strip_tags($data['message'])."\n----------------------------------------------\n\n";
        $body .= JRoute::_('index.php?option=com_vitabook&task=message.activate&format=raw&messageId='.$data['id'].'&code='.VitabookHelperMail::getMailHash($data['id'],'activate'), true, -1);
        return $body;
    }
