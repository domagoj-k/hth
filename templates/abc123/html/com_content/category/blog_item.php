...
<tr>
	<td valign="top">
		<span class="small spacer">
			<?php if ($this->params->get('show_create_date')) : ?><span class="info_date"><?php echo JHTML::_('date', $this->article->created, JText::_('DATE_FORMAT_LC2')) ?></span><?php endif; ?><?php if ((($this->params->get('show_author')) && ($this->article->author != "")) && $this->params->get('show_create_date')) : ?> | <?php endif; ?><?php if (($this->params->get('show_author')) && ($this->article->author != "")) : ?><span class="info_author"><?php JText::printf( 'Written by', ($this->escape($this->article->created_by_alias) ? $this->escape($this->article->created_by_alias) : $this->escape($this->article->author)) ); ?></span><?php endif; ?>
		</span>
	</td>
</tr>
<?php endif; ?>
