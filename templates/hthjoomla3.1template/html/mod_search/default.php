...
<form action="index.php?searchword=<?php echo $text; ?>&amp;ordering=&amp;searchphrase=all&amp;option=com_search" method="post">
	<div class="search<?php echo $params->get('moduleclass_sfx') ?>">
		<?php
			...
			if ($button) :
			    if ($imagebutton) :
			        $button = '<span class="submit_btn"><input type="image" value="'.$button_text.'" class="button'.$moduleclass_sfx.'" src="/images/M_images/searchButton.gif" onclick="this.form.searchword.focus();"/></span>';
			    else :
